...
public class MainActivity extends AppCompatActivity {
    ...
    Button back_button, next_button, add_link_button, clear_link_button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clear_link_button = findViewById(R.id.clearbtn);
        ...
        arrayList.add(0,"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTV63AVl7ncYOzoDtYAgaDdBLHYnqHpgfByobrtV4ocBSDSI66Z8OovJD7YGBRMm67HaKc&usqp=CAU");
        arrayList.add(1,"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRM0s6KNP70TB_8M_cIcghmC6s6t1d5kDKuHA&usqp=CAU");
        arrayList.add(2,"https://images5.alphacoders.com/975/975315.jpg");
